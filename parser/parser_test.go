...
var _ = Describe("Parser", func() {
	...
	DescribeTable("functions",
		...
		Entry("abs", "abs", parser.NFnAbs, nil),
		Entry("asin", "asin", parser.NFnAsin, nil),
		Entry("acos", "acos", parser.NFnAcos, nil),
		Entry("atan", "atan", parser.NFnAtan, nil),
		Entry("ceil", "ceil", parser.NFnCeil, nil),
		Entry("floor", "floor", parser.NFnFloor, nil),
		Entry("cbrt", "cbrt", parser.NFnCbrt, nil),
		Entry("log", "log", parser.NFnLog, nil),
		Entry("log2", "log2", parser.NFnLog2, nil),
		Entry("log10", "log10", parser.NFnLog10, nil),
		Entry("signbit", "signbit", parser.NFnSignbit, nil),
		Entry("trunc", "trunc", parser.NFnTrunc, nil),
